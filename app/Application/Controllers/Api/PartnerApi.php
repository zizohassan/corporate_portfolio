...
use App\Application\Transformers\PartnerTransformers;
...
class PartnerApi extends Controller
{
    ...
    public function __construct(Partner $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(PartnerTransformers::transform($data))  , 200 );
    }
