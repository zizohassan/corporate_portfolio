...
use App\Application\Transformers\TestimonialTransformers;
...
class TestimonialApi extends Controller
{
    ...
    public function __construct(Testimonial $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(TestimonialTransformers::transform($data))  , 200 );
    }
