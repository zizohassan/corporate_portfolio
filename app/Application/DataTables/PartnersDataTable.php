...
class PartnersDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
             ->eloquent($this->query())
             ->addColumn('edit', 'admin.partner.buttons.edit')
             ->addColumn('delete', 'admin.partner.buttons.delete')
             ->addColumn('view', 'admin.partner.buttons.view')
             ->make(true);
    }
    /**
    ...
    {
        return 'Partnerdatatables_' . time();
    }
}