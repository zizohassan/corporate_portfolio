...
class TestimonialsDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
             ->eloquent($this->query())
             ->addColumn('edit', 'admin.testimonial.buttons.edit')
             ->addColumn('delete', 'admin.testimonial.buttons.delete')
             ->addColumn('view', 'admin.testimonial.buttons.view')
             ->make(true);
    }
    /**
    ...
    {
        return 'Testimonialdatatables_' . time();
    }
}